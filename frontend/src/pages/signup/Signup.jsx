        ...
        <form onSubmit={handleSubmit}>
          <div>
            <label className='label p-2'>
              <span className='text-base label-text-alt text-gray-400'>
                Full Name
              </span>
            </label>
            <input
          ...
          <div>
            ...
            <input
              ...
              placeholder='john.doe@example.com' // Placeholder for email
              className='w-full input input-bordered h-10'
          ...
          <Link
            to={"/login"}
            className='text-gray-400 text-sm hover:underline hover:text-red-400 mt-2 inline-block'
            href='#'
          >
